  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Registrar Propiedad</Text>
      </View>
            ...
            <Controller
              ...
              render={({ field: { onChange, value } }) => (
                <View style={styles.radioGroup}>
                  <TouchableOpacity 
                    style={[styles.radioButton, value === 'Casa' && styles.radioButtonSelected]}
                    onPress={() => onChange('Casa')}
                  >
                    <Text style={[styles.radioText, value === 'Casa' && styles.radioTextSelected]}>Casa</Text>
                  </TouchableOpacity>
                  <TouchableOpacity 
                    style={[styles.radioButton, value === 'Apartamento' && styles.radioButtonSelected]}
                    onPress={() => onChange('Apartamento')}
                  >
                    <Text style={[styles.radioText, value === 'Apartamento' && styles.radioTextSelected]}>Apartamento</Text>
                  </TouchableOpacity>
                  <TouchableOpacity 
                    style={[styles.radioButton, value === 'Terreno' && styles.radioButtonSelected]}
                    onPress={() => onChange('Terreno')}
                  >
                    <Text style={[styles.radioText, value === 'Terreno' && styles.radioTextSelected]}>Terreno</Text>
                  </TouchableOpacity>
                  <TouchableOpacity 
                    style={[styles.radioButton, value === 'Comercial' && styles.radioButtonSelected]}
                    onPress={() => onChange('Comercial')}
                  >
                    <Text style={[styles.radioText, value === 'Comercial' && styles.radioTextSelected]}>Comercial</Text>
                  </TouchableOpacity>
                </View>
              )}
            />
